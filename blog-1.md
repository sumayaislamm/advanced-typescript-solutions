...
Generics হলো Typescript এর অন্যতম গুরুত্বপূর্ণ একটি ফিচার যেটা দিয়ে ডেভেলপাররা নির্ভুল এবং বার বার ব্যবহারযোগ্য কোড লিখতে পারেন, এটা দিয়ে ডেভেলপাররা বিভিন্ন ফাংশন এবং কম্পোনেন্ট বানাতে পারেন বিভিন্ন ধরনের ডাটা দিয়ে যেমন: Primitive Data and Non-Primitive Data.
